...
global_symbol_table.set("robwoodisthebestprogrammer", Number(1))  # null
global_symbol_table.set("robwoodisnotthebestprogrammer", Number(0))  # null
...
# Stopped at 0:00 here: https://www.youtube.com/watch?v=r46EONXC1i0
